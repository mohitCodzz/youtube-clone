...
const Feed = () => {
  // Array of video data
  const videos = [
    { thumbnail: thumbnail10, title: "Night Sky from ISRO HQ 🚀", channel: "SpaceX", views: "100M views", time: "1 day ago", videoId: "video10" },
    ...
    { thumbnail: thumbnail3, title: "A day in New York", channel: "TechWorld", views: "5M views", time: "2 days ago", videoId: "video3" },
